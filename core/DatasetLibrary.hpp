...
#ifndef SEAMASS_DATASETLIBRARY_HPP
#define SEAMASS_DATASETLIBRARY_HPP
...
class DatasetLibrary: public Dataset
{
public:
    DatasetLibrary(const std::string& filePathIn, const std::string& filePathStemOut, Dataset::WriteType writeType = Dataset::WriteType::InputOutput);
    virtual ~DatasetLibrary();
