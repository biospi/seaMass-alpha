...
#include "seaMassRestoration.hpp"
#include "BasisFunctions.hpp"
#include "OptimiserASRL.hpp"


seaMassRestoration::
seaMassRestoration(const std::string& _id, int _instrument_type, int _debug) :
    id(_id),
    h5out(_id),
...
{
    cout << endl;
    cout << "seaMass Restoration - Copyright (C) 2013 - CADET Bioinformatics Laboratory, University of Manchester, UK" << endl;
    cout << "This program comes with ABSOLUTELY NO WARRANTY." << endl;
    cout << "This is free software, and you are welcome to redistribute it under certain conditions." << endl;
    cout << endl;
    cout << "Input id=" << id << " instrument_type=" << instrument_type << " debug=" << debug << endl;
...
void
seaMassRestoration::
process(const std::string& config_id,
        vector<double>& rts,
...
{
    cout << endl << "Config id=" << config_id << endl;
    ...
    // write to h5
    ostringstream ossg; ossg << config_id << "/gs";
    h5out.write_fs(ossg.str(), gs, is, js);
