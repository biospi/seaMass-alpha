...
cmake -DCMAKE_BUILD_TYPE=Debug $@ -DCMAKE_INSTALL_PREFIX=../../../install/gcc/debug ../../..
make -j $1
make install
popd
...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=../../../install/gcc/release $@ ../../..
make -j $1
make install
popd

### commented out as these test mzMLb datasets are old format
