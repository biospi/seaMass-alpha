...
{
protected:
	void apply(li row, li col, T** alpha){};
	void axisRT(li dims, int _offset, double rt_res, vector<double> &_rt);
	void axisMZ(li dims, int _offset, double mz_res, vector<double> &_mz);
	~OpUnitS(){};
};
