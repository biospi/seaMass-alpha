...
void BsplineBasisData<R,T>::dumpData(string filename, nc_type data_type_id)
{
    ...
    smpDataFile.writeVector("csOrig",bs->alpha->v,data_type_id);
    smpDataFile.writeVector("dhcs",dhbs->alpha->v,data_type_id);
    smpDataFile.writeVector("dh2cs",dh2bs->alpha->v,data_type_id);
    smpDataFile.writeVector("dvcs",dvbs->alpha->v,data_type_id);
    smpDataFile.writeVector("dv2cs",dv2bs->alpha->v,data_type_id);
}
