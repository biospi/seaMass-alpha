...
int main(int argc, const char* const* argv)
{
...
#endif
    {
        ...
        po::options_description general(
            "Usage\n"
            "-----\n"
            "csv2binned [OPTIONS...] [txt FILE]\n"
            "csv2binned <-m mz_scale> <file>"
        );
        ...
        general.add_options()
            ...
            ("mz_scale,m", po::value<int>(&mzScale)->default_value(11),
            ...
            ("mz_max,1", po::value<double>(&mzMax)->default_value(100000.0),
        ...
        {
            cout << endl;
            cout << "csv2binned : Copyright (C) 2025 - biospi Laboratory, University of Bristol, UK" << endl;
