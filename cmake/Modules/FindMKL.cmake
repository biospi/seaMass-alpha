...
if(MKL_FOUND)
  ...
  if(USE_MKL_64BIT)
    ...
    if (WIN32)
      ...
      set(MKL_COMPILER_LIB_DIR "${MKLROOT_PATH}/lib/ia32")
  ...
  if(APPLE)
    ...
    set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_COMPILER_LIB_DIR}/libiomp5.dylib)
  else(APPLE)
    if(WIN32)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel_thread.lib)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_core.lib)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_COMPILER_LIB_DIR}/libiomp5md.lib)
   else (WIN32)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/libmkl_intel_thread.so)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/libmkl_core.so)
      set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_COMPILER_LIB_DIR}/libiomp5.so)
    endif(WIN32) 
  endif(APPLE)
