...
if (MKL_FOUND)
    ...
    if ( USE_MKL_64BIT )
        ...
        if ( USE_MKL_64BIT_LIB )
                if (WIN32)
                    ...
                    set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel_ilp64)
                endif (WIN32)
        else ( USE_MKL_64BIT_LIB )
                if (WIN32)
                    set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel_lp64.lib)
                else (WIN32)
                    set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel_lp64)
                endif (WIN32)
        ...
        if ( WIN32 )
            set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel_c)
        else ( WIN32 )
            set(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_intel)
        endif ( WIN32 )
    endif ( USE_MKL_64BIT )
    ...
    if (WIN32)
        ...
        SET(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_gnu_thread)
        SET(MKL_LIBRARIES ${MKL_LIBRARIES} ${MKL_LIB_DIR}/mkl_core)
    endif (WIN32) 
endif (MKL_FOUND)
