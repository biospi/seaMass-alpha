...
if(INTEL_FOUND)
  ...
  if(APPLE)
    ...
    set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libippi.dylib)
    set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libippvm.dylib)
    ...
    if(WIN32)
      ...
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/ippvm.lib)
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/ipps.lib)
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/ippi.lib)
      ...
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libippcore.so)
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libippvm.so)
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libipps.so)
      set(INTEL_LIBRARIES ${INTEL_LIBRARIES} ${IPP_LIB_DIR}/libippi.so)
