...
if ( WIN32 )
  ...
  if (DEFINED ENV{IntelOpenMPROOT_PATH})
    ...
    if ( APPLE )
      set(IntelOpenMPROOT_PATH "/opt/intel/compilers_and_libraries/mac" CACHE PATH "Where the IntelOpenMP are stored")
    else ( APPLE )
...
if (IntelOpenMP_FOUND)
    ...
    if ( APPLE )
        set(IntelOpenMP_LIB_DIR "${IntelOpenMPROOT_PATH}/lib")
        set(IntelOpenMP_COMPILER_LIB_DIR "${IntelOpenMPROOT_PATH}/lib")
        set(IntelOpenMP_LIBRARIES ${IntelOpenMP_LIBRARIES} ${IntelOpenMP_LIB_DIR}/libiomp5.dylib)
    else ( APPLE )
